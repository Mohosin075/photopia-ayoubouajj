...
const availabilityPeriodSchema = zod_1.z.object({
    startDate: zod_1.z
        .string()
        .or(zod_1.z.date())
        .transform(val => new Date(val)),
...
const blockedDateRangeSchema = zod_1.z.object({
    startDate: zod_1.z
        .string()
        .or(zod_1.z.date())
        .transform(val => new Date(val)),
...
exports.createAvailabilityValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        availabilityPeriods: zod_1.z.array(availabilityPeriodSchema).optional(),
        blockedDateRanges: zod_1.z.array(blockedDateRangeSchema).optional(),
