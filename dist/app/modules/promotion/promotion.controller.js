...
const validatePromotion = (0, catchAsync_1.default)(async (req, res) => {
    const { code } = req.body;
    const user = req.user;
    const result = await promotion_service_1.PromotionService.validatePromotion(code, user.userId);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
...
const applyPromotion = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const user = req.user;
    const result = await promotion_service_1.PromotionService.applyPromotion(code, user.userId, amount);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
