...
export const createProfessionalProfileSchema = z.object({
  body: z.object({
    ...
    primaryDomain: z
      .array(z.enum(['Photography', 'Videography', 'Editing']))
