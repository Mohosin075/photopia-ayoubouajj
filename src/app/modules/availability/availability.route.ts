...
router.get('/check/:providerId', AvailabilityController.checkDateAvailability)

// Public endpoint to get available time slots for a specific date
router.get('/slots/:providerId', AvailabilityController.getTimeSlots)

// Public endpoint to get month calendar overview
router.get('/calendar/:providerId', AvailabilityController.getMonthCalendar)
